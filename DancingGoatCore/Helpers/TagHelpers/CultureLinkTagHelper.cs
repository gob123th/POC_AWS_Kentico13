...
namespace DancingGoat.Helpers
{
    public class CultureLinkTagHelper : TagHelper
    {
        ...
        public CultureLinkTagHelper(IHttpContextAccessor httpContextAccessor, IPageDataContextRetriever pageDataContextRetriever, IUrlHelperFactory urlHelperFactory, IHtmlGenerator htmlGenerator, ISiteService siteService)
        {
