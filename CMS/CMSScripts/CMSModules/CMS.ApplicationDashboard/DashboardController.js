        ...
        */
        function Controller($scope, $window, $document, $timeout, $animate, __tiles) {
            ...
            */
            ...
            // Toggle the visibility of the XbyK news tile event handler
            $scope.$on("toggleXbykNewsTile", (e, value) => this.$scope.model.displayXbykNewsTile = value);
