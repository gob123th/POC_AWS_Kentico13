...
CMSConfigRequire = function (baseUrl, pathToCmsScripts) {
    cmsrequire.config({
        ...
        paths: {
            ...
            'angular': pathToCmsScripts + 'Vendor/Angular-1.8.3/angular.min',
            'angular-resource': pathToCmsScripts + 'Vendor/Angular-1.8.3/angular-resource.min',
            'angular-sanitize': pathToCmsScripts + 'Vendor/Angular-1.8.3/angular-sanitize.min',
            'angular-route': pathToCmsScripts + 'Vendor/Angular-1.8.3/angular-route.min',
            'angular-animate': pathToCmsScripts + 'Vendor/Angular-1.8.3/angular-animate.min',
