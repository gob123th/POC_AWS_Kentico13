...
<asp:Content ID="cntBody" ContentPlaceHolderID="plcContent" runat="server">
    <%-- XbyK news tile --%>
    <script type="text/ng-template" id="xbykNewsTemplate.html">
        <div class="xbyk-news-tile">
            <div class="xbyk-news-tile-header">
                <h3 data-ng-if="model.header"><i class="icon-light-bulb"></i> {{model.header}}</h2>
                <a href="javascript:void(0)" data-ng-click="model.hide()" class="modal-close">
                    <i aria-hidden="true" class="icon-modal-close"></i>
                </a>
            </div>
            <div class="xbyk-news-content"> 
                <div class="lead" data-ng-if="model.description" data-ng-bind-html="model.description"></div>
            
                <div class="xbyk-news-cta" data-ng-if="model.ctaUrl && model.ctaLabel">
                    <a data-ng-href="{{model.ctaUrl}}" target="_blank" class="btn btn-primary news-link">
        ...
        <div class="dashboard">
            <div id="dashboard-drag-area" class="dashboard-inner" data-ng-class="{'edit-mode' : model.isEditableMode}">
                <ul data-ui-sortable="model.sortableOptions" data-ng-model="model.tiles">
                    <li data-xbyk-news-tile data-ng-show="model.displayXbykNewsTile" class="tile" data-no-drag="no-drag"></li>
